...
# Forzamos el modo copia para evitar el "os error 1"                                                 echo "[*] Instalando typing_extensions y dependencias base..."
...
gdb -q -ex "quit" && echo "[!] GDB cargó Pwndbg exitosamente" || echo "[?] Si sigue fallando, ejecut>
